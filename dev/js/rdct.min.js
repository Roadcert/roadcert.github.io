 document.onreadystatechange = function () {
      if (document.readyState == "interactive") {
                var videoStorage = [/*
                    'https://s3-eu-west-1.amazonaws.com/roadcert-cdn/assets/videos/lights',
                    'https://s3-eu-west-1.amazonaws.com/roadcert-cdn/assets/videos/moving_lights',*/
                    'https://s3-eu-west-1.amazonaws.com/roadcert-cdn/assets/videos/traffic'/*,
                    'https://s3-eu-west-1.amazonaws.com/roadcert-cdn/assets/videos/wheels',
                    'https://s3-eu-west-1.amazonaws.com/roadcert-cdn/assets/videos/workers'*/
                ];
...
function pricingResize(){
  ...
  if(width <= 840  && moved != 1){ //clone normal pricing and modify
   ...
   $("#tmp-hcard .apv").html("£79<br/><small>annually per vehicle</small>");
   $("#tmp-hcard .price").html("£1.51<small>pw</small>");
...
$("div.blast-animate")
        ...
        .velocity("transition.fadeIn", {
                ...
                complete: function() {
                        ...
                        $("div.blast-animate").blast({search: "fleet management" }).velocity({color: "#ffffff", "font-weight": "bold"}, {duration: 200});//#f2646e
                        $("div.blast-animate").blast({search: "digitised" }).velocity({color: "#ffffff", fontWeight: "bold"}, {delay:200, duration: 200});//#fbb040
                        $("div.blast-animate").blast({search: "revolutionised" }).velocity({color: "#ffffff", fontWeight: "bold"}, {delay: 400, duration: 200,//#8dc63f
                                complete: function() {
...
if ($("#top").offset().top <= 0) $("#contact-header-btn").removeClass("hide").css({opacity: 0}).velocity({opacity: 1}, {duration: 2000});
        ...
        if ($("#feature2").offset().top < 500 && !feature2Animate) {
            ...
            $("#feature2-headings")
                        ...
                        .velocity("transition.fadeIn", {
                                stagger: 30,
                                complete: function() {
                                        $("#feature2-headings").removeClass("hide");
                                        $("#feature2-headings").blast(false);
                                        $("#feature2-headings").blast({search: "Roadcert"}).velocity({color: "#f2646e", "font-weight": "bold"}, {duration: 250});
                                        $("#feature2-headings").blast({search: "At it's best" }).velocity({color: "#fbb040", fontWeight: "bold"}, {delay: 250, duration: 250});
                                        $("#feature2-headings").blast({search: "For you" }).velocity({color: "#8dc63f", fontWeight: "bold"}, {delay: 500, duration: 250});
                                }
                });
        }

        if ($("#feature2").offset().top < -100 && !feature2AnimateLi) {
                feature2AnimateLi = true;
                $("#f2-wb .documents").css({"visibility": "visible"});
                $("#f2-wb .documents").removeClass("hide");

                $("#f2-wb .documents li").css({"opacity": 0});
                $("#f2-wb .documents li").velocity("transition.slideUpIn", {
                        stagger: 140,
                        display: null,
                        drag: true
                });
                ...
                setTimeout(function(){
                  $("#f2-wb .below-docs li").velocity("transition.slideLeftIn", {
                          stagger: 200,
                          display: null,
                          drag: true
                  });
...
function ValidateForm(){
  ...
  var organisation= $('#mce-ORGANISATION').val();
  ...
  if ((fname==null)||(fname=="")){
    ...
    $('#form-errors #no_organisation').fadeIn('slow');
    $('#mce-ORGANISATION').focus();
    return false
