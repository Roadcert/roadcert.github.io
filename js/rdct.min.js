...
$('.android-content').scroll(function() {
        ...
        if ($("#feature2").offset().top < 550 && !feature2Animate) {
        ...
        if ($("#earned-rec-section").offset().top < 675 && !earnedRecSecAnimate) {
          earnedRecSecAnimate = true;
          $("#earned-rec-section").animate({ height: '+642'}, 600);
        }
